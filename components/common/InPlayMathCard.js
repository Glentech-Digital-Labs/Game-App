    ...
    >
      ...
      <div className="tw-flex tw-justify-between tw-mx-4 ">
        ...
        <div className="tw-flex tw-justify-end ">
          <button
            className=" tw-border-b-4 tw-border-[#5975B8]  tw-w-16  tw-h-12 tw-self-end tw-text-center betting-box tw-rounded-lg back-button shimmer-element"
            style={{
              backgroundImage:
          ...
          <button
            className="tw-border-b-4 tw-border-[#B87A85]  tw-w-16  tw-h-12 tw-self-end tw-ml-4 tw-text-center betting-box tw-rounded-lg shimmer-element"
            style={{
              backgroundImage:
